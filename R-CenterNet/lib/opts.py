...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--num_epochs', type=int, default=160,
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [512, 1024], 'num_classes': 20, #37, 
                'mean': [0.054088, 0.049143, 0.045313], 'std': [0.173285, 0.160391, 0.153069],
                'dataset': 'coco'},
